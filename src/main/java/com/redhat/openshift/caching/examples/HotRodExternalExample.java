 ...
 */
public class HotRodExternalExample {
    ...
    public static void main(String[] args) throws FileNotFoundException, InterruptedException {
        ...
        if( args.length < 1) {
            System.out.println("You need to supply the name of the Hot Rod server endpoint (example: caching-service-endpoint-hotrod-<my-project>.<id>.<cluster>.openshiftapps.com)");
            return;
        }
        ...
        if (!new File(TRUST_STORE_NAME).exists()) {
            System.out.println("You need to generate a trust store with the service certificate first. Please, execute:\n\n" +
